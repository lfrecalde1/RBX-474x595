...
def train(modelConfig: Dict):
    ...
    if modelConfig["augmented_data"] == "No":
        ...
        dataset = generation(modelConfig)
    ...
    np.save(os.path.join(modelConfig["save_dir"], "train_loss.npy"),np.array(trainLossList))
    np.save(os.path.join(modelConfig["save_dir"], "val_loss.npy"),np.array(valLossList))
...
def generation(modelConfig: Dict):
